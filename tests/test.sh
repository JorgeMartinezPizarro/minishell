...
test_command "(true && echo A | grep A) || (echo B | grep B)"
test_command "(echo hola || echo adios) | grep ad"
test_command "echo hola | (grep h && echo found)"
test_command "(false && echo no) || (echo hola | grep h)"
test_command "true && echo hola | grep h || echo nunca"
test_command "echo hola | (cat | grep h) && echo ok"
test_command "(echo hola && false) | cat || echo fallback"
